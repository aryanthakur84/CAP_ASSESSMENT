sap.ui.define([
	...
	"pomanagement/test/integration/pages/PurchaseOrdersList",
	"pomanagement/test/integration/pages/PurchaseOrdersObjectPage",
	"pomanagement/test/integration/pages/PurchaseOrderItemsObjectPage"
], function (JourneyRunner, PurchaseOrdersList, PurchaseOrdersObjectPage, PurchaseOrderItemsObjectPage) {
    'use strict';

    var runner = new JourneyRunner({
        launchUrl: sap.ui.require.toUrl('pomanagement') + '/test/flp.html#app-preview',
        pages: {
